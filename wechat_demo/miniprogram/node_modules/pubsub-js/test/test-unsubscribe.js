...
var PubSub = require('pubsub-js'),
    TestHelper = require('pubsub-js/test/helper'),
    assert = require('pubsub-js/test/node_modules/referee').assert,
    refute = require('pubsub-js/test/node_modules/referee').refute,
    sinon = require('pubsub-js/test/node_modules/sinon');
